...
def getLatestScreenShot():
    list_of_files = glob.glob(
        "D:\Projects\OpenCV_3_License_Plate_Recognition_Python-master\LicPlateImages\*")
    # print(list_of_files)
...
def main():
    ...
    imgOriginalScene = cv2.imread("LicPlateImages\\"+latestScreenshot)  # open image
    ...
    if len(listOfPossiblePlates) == 0:  # if no plates were found
        ...
        # cv2.imshow("imgPlate", licPlate.imgPlate)                # re-show scene image
        # os.chdir(path="Plates")
        cv2.imwrite("Plates\\imgPlate.png", licPlate.imgPlate)  # write image out to file
