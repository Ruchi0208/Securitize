...
# Form implementation generated from reading ui file 'Visitor Check_OutF.ui'
#
...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow, NumPlate):
        ...
        item.setText(_translate("MainWindow", "In_Vehicle No"))
        item = self.tableWidget.horizontalHeaderItem(3)
        item.setText(_translate("MainWindow", "In Time"))
        item = self.tableWidget.horizontalHeaderItem(4)
        item.setText(_translate("MainWindow", "Out_Time"))
